        ...
        <div class="panel-body">
            ...
            <form action="{{ url('/jurnal/store') }}" id="form1" class="form-horizontal row-border" method="POST">
                ...
                <div class="form-group">
					...
					<div class="col-md-6">
						<textarea class="form-control autosize" name="catatan" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 237px;  overflow-y: auto;">{{Request::old('catatan')}}</textarea>
					</div>
